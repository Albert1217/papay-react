...
import PausedOrders from "../../component/orders/pausedOrders";
import ProcessOrders from "../../component/orders/processOrders";
import FinishedOrders from "../../component/orders/finishedOrders";
        ...
        <Stack className={"order_right"}>
          <Box className={"order_info_box"}>
            ...
            >
              <div className={"order_user_img"}>
                <img src={"/home/user3.svg"} className={"order_user_avatar"} />
                <div className={"order_user_icon_box"}>
                  <img
                    src={"/icons/goshtlitaom.svg"}
          ...
          <Box className={"order_info_box"} sx={{ mt: "15px" }}>
            <input
              type={"text"}
              name={"card_number"}
              placeholder={"Card number : 5247 4090 2002 7495"}
            ...
            <input
              type={"text"}
              name={"card_creator"}
              placeholder={"Mukhtorov Ismoiljon"}
              className={"card_input"}
            />
