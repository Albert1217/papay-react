...
const actionDispatch = (dispach: Dispatch) => ({
  setTrenProducts: (data: Product[]) => dispach(setTrendProducts(data)),
});
...
export function BestDishes() {
  //** INITIALIZATION */
  const { setTrenProducts } = actionDispatch(useDispatch());
                ...
                <Box className="dish_box">
                  ...
                  >
                    ...
                    <div className={"view_btn"}>
                      <div>Batafsil korish</div>
                      <img
                        src={"/icons/arrow_righ.svg"}
